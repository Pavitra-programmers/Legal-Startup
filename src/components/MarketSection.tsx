const stats = [
  ...
  { value: "4.5 Cr", label: "Pending cases in Indian courts, many stemming from preventable disputes" },
    ...
    <section id="market" className="section-padding bg-secondary text-secondary-foreground">
      <div className="max-w-7xl mx-auto">
        ...
        <h2 className="text-2xl sm:text-3xl md:text-5xl font-heading font-bold max-w-3xl leading-tight mb-4 sm:mb-6">
          Millions of encounters. Zero legal support.
        </h2>
        <p className="text-sm sm:text-base text-secondary-foreground/70 max-w-2xl mb-12 sm:mb-16 leading-relaxed">
          Every day across India, citizens face traffic stops, document checks, and roadside
          encounters with no access to legal guidance. The infrastructure for real-time access
          to justice simply does not exist — and NyayaJustis is building it.
        </p>
